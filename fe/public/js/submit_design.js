...
if ($submitDesignFormContainer.length != 0) {
    ...
    $('#submitButton').on('click', function(event) {
        ...
        webFormData.append("file", new Blob([document.getElementById('fileInput').files[0]], {type:'multipart/form-data'}));
        axios({
                method: 'post',
                url: 'https://y2d1tebz53.execute-api.us-east-1.amazonaws.com/test/submitdesign?file=' + document.getElementById('fileInput').files[0],
                data: webFormData,
