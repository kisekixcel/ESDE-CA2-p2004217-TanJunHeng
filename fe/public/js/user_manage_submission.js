...
if ($searchDesignFormContainer.length != 0) {
    ...
    $('#submitButton').on('click', function(event) {
        ...
        axios({
                ...
                method: 'get',
                url: 'https://y2d1tebz53.execute-api.us-east-1.amazonaws.com/test/getalldesign?fid=' + userId + '&pageNumber=1',
            })
            .then(function(response) {
                ...
                const totalNumOfRecords = response.data.filedata.length;
                ...
                for (let index = 0; index < response.data.filedata.length; index++) {
